...
<g>
	...
	foreach ($streetArray as $key => $value) {
		$y = $y + 65;
		?>
	  	<text id="circleResize" text-anchor="middle" x="<?= $x; ?>" y="<?= $y; ?>" font-size="<?= $text_font_size; ?>" style="font-family: <?= $font; ?>"><?= $value; ?></text>
	  	<?php
	}
	?>
...
<g>
	...
	<rect x="655" y="400" width="70" height="37.9"/>
	<rect x="104.4" y="400" width="70" height="37.9"/>
</svg>