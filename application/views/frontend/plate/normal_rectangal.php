...
<g>
	...
	<g>
		...
		foreach ($streetArray as $key => $value) {
			$y = $y + 65;
			?>
		  	<text id="circleResize" text-anchor="middle" x="<?= $x; ?>" y="<?= $y; ?>" font-size="<?= $text_font_size; ?>" class="st8"  style="text-transform: uppercase;font-family: <?= $font; ?>"><?php echo  $value; ?></text>
		  	<?php
		}
		?>
		<?php
