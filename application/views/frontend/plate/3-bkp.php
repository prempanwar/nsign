...
if($logo) {
	if($logo_position) {
		?>
		<image xlink:href="<?= $logo; ?>" height="140" width="150" x="320" y="150"/>
		<?php
	}
	else {
		?>
...
?>
	<rect x="731" y="417.2" class="st5" width="7" height="37.9"/>
	<rect x="104.4" y="417.2" class="st5" width="7" height="37.9"/>
</svg>