...
<div class="login-box">
  <div class="login-logo">
    <!-- <a href="<?php echo base_url(); ?>"><img class="img-rounded" src="<?php echo base_url("assets/images/dwdwdwed.png"); ?>" alt="" style=" width:200px;"></a> -->
    <h1>:: NSIGN ::</h1>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo site_url('backend/admin/login'); ?>" method="post">
      ...
      <div class="form-group has-feedback" style="text-align: center;color: red;">
        <span><?php echo @$_SESSION['err_ind']; $_SESSION['err_ind'] = '';?></span>
      </div>
      <div class="row">
        <div class="col-xs-8">
        ...
        <!-- /.col -->
                      ...
                      <div class="row" style="text-align: right;margin-top: 20px;"><a href="" target="_blank"></a></div>
