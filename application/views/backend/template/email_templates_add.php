...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fa fa-arrow-circle-o-right"></i> Add Email Template</h1>
<!--         <ol class="breadcrumb">
                    ...
                    <form role="form" class="form-horizontal tasi-form" action="<?php echo current_url()?>" enctype="multipart/form-data" method="post" data-parsley-validate>
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="template_subject" value="<?php echo set_value('template_subject');?>" required maxlength="100" data-parsley-required-message="Template subject is required"><?php echo form_error('template_subject'); ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Email Template Body<span class="error">*</span> :</label>
                                <div class="col-md-10">
                                    <textarea  class="tinymce_edittor form-control" cols="100" rows="7" name="template_body" required data-parsley-required-message="Email template body is required"><?php echo set_value('template_body'); ?></textarea><?php echo form_error('template_body'); ?>
                                </div>
                            </div>
                        </div>
