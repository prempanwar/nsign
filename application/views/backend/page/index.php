<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fa fa-arrow-circle-o-right"></i> Page Templates</h1>
        <!-- <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="bread_parent">
                <ul class="breadcrumb">
                    ...
                    <li><b>Page Templates</b></li>
                    <div class="btn-group pull-right" style="margin-top:-7px;">
                        <a class="btn btn-primary btn-sm tooltips" href="<?php echo base_url('backend/page/page_templates_add');?>" id="add" data-original-title="Click to add the Page"><i class="icon-plus"> Add Page Templates &nbsp;</i>
                        </a>
                    </div>
                </ul>
            </div>
                    ...
                    <table id="myTable" class="table table-striped table-hover" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="ms">
                                    <a href="<?php echo base_url().'backend/page/page_templates_edit/'.$row->id ?>" class="btn btn-primary btn-xs tooltips" rel="tooltip"  data-placement="left" data-original-title="Edit" ><i class="fa fa-pencil-square-o"></i></a>
                                    <!-- <a class="btn btn-danger btn-xs tooltips" rel="tooltip"  data-placement="top" data-original-title="Delete This Page Template" onclick="if(confirmBox('Are you sure want to delete?','<?php echo base_url().'backend/page/page_templates_delete/'.$row->id ?>')){return true;} else {return false;}" ><i class="fa fa-trash-o"></i></a> -->
                                </td>
                            </tr>
                            <?php $j++;  endforeach; ?>
                        </tbody>
