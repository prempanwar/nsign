...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fa fa-arrow-circle-o-right"></i> Edit Page Template</h1>
<!--         <ol class="breadcrumb">
                    ...
                    <form role="form" class="form-horizontal tasi-form" action="<?php echo current_url()?>" enctype="multipart/form-data" method="post" data-parsley-validate>
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="template_name" value="<?php if(!empty($page_template[0]->template_name)) echo $page_template[0]->template_name ; else echo set_value('template_name'); ?>" required maxlength="100" data-parsley-required-message="Template name is required"><?php echo form_error('template_name'); ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Email Template Body<span class="error">*</span> :</label>
                                <div class="col-md-10">
                                    <textarea  class="tinymce_edittor form-control" cols="100" rows="7" name="template_body" required data-parsley-required-message="Email template body is required"><?php if(!empty($page_template[0]->template_body)) echo $page_template[0]->template_body; else echo set_value('template_body'); ?></textarea><?php echo form_error('template_body'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions fluid">
                            <div class="col-md-offset-2 col-md-10">
                                ...
                                <a href="<?php echo base_url()?>backend/page" class="btn btn-danger" >Cancel
                                </a>                              
                            </div>
                        </div>
                    </form>
