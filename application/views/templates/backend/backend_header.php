...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="<?= base_url('backend/admin/dashboard'); ?>" class="logo">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        <li class="dropdown user user-menu">
                            <a href="<?= base_url("backend/admin/logout"); ?>" class="dropdown-toggle">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    <li class="<?php if($segment3 == 'dashboard') { echo "active treeview"; } ?>">
                        <a href="<?php echo site_url("backend/admin/dashboard"); ?>">
                    ...
                    <li class="<?php if($segment2 == 'orders') { echo "active treeview"; } ?>"> 
                        <a href="<?php echo site_url("backend/orders"); ?>">
                    ...
                    <li class="<?php if($segment3 == 'council') { echo "active treeview"; } ?>"> 
                    ...
                    <li class="<?php if($segment3 == 'favorite_users') { echo "active treeview"; } ?>"> 
                        <a href="<?php echo site_url("backend/admin/favorite_users"); ?>">
                            <i class="fa fa-circle-o"></i>
                    ...
                    <li class="<?php if($segment2 == 'template') { echo "active treeview"; } ?>"> 
                        <a href="<?php echo site_url("backend/template"); ?>">
                            <i class="fa fa-circle-o"></i>
                    ...
                    <li class="<?php if($segment2 == 'page') { echo "active treeview"; } ?>"> 
                        <a href="<?php echo site_url("backend/page"); ?>">
                            <i class="fa fa-circle-o"></i>
                    ...
                    <li class="<?php if($segment3 == 'optionsettings') { echo "active treeview"; } ?>"> 
                        <a href="<?php echo site_url("backend/admin/optionsettings"); ?>">
                            <i class="fa fa-circle-o"></i>
                    ...
                    <li class="<?php if($segment3 == 'delivery_charge') { echo "active treeview"; } ?>"> 
                        <a href="<?php echo site_url("backend/admin/delivery_charge"); ?>">
                            <i class="fa fa-circle-o"></i>
